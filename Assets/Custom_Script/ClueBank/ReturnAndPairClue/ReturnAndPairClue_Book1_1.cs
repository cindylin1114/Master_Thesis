...
public class ReturnAndPairClue_Book1_1 : MonoBehaviour // 用來將置於線索庫的「關鍵字」配對到對應的測驗題目；將關鍵字放回初始位置(歸位至書籍區) (附加在 Clue_bank - Clue_Bank_Content - keyword_area1_1_Collection)
{
    ...
    void Update()
    {
        ...
        // 開啟「重選線索」功能
        if (gameManager.ClueNum_Book1 > 0 && !gameManager.FinishExam_Book1) // 有關鍵字在線索庫中才會有「重選線索」功能
        {
        ...
        // 關鍵字蒐集進度
        if (gameManager.ClueNum_Book1 >= limitNum) // 如果關鍵字蒐集數量達到指定要求(目前設定需要蒐集"限制數量"關鍵字)
        {
            ...
            gameManager.ClueComplete_Book1 = true; // 記錄該書的線索已經蒐集完畢
        } 
        else
        {
            BookTitle.text = BookName + "(" + gameManager.ClueNum_Book1 + "/" + limitNum + ")"; // 顯示關鍵字蒐集進度

            BookTitle.color = Color.black;

            BookImage.sprite = UnknownSprite;

            gameManager.ClueComplete_Book1 = false;

            CheckPoint.SetActive(false); // 未達成蒐集數量，書籍測驗畫面不會開啟
        }


        if (gameManager.ClueComplete_Book1)
        {
        ...
        if (gameManager.Book1_Question1 && gameManager.Book1_Question2 && gameManager.Book1_Question3 && gameManager.Book1_Question4 && gameManager.Book1_Question5 && gameManager.Book1_Question6) // 如果在CheckPoint視窗中，書籍測驗中的問題全部回答正確後
        {
            gameManager.FinishExam_Book1 = true;
    ...
    {
        Debug.Log("Reselect the Clue from Book1");
    ...
    {
        Debug.Log("Return Book1_Keyword1");

        if (gameManager.ClueNum_Book1 > 0) // 如果未達指定關鍵字蒐集數量
        {
            gameManager.Book1_Keyword1 = false; // 該關鍵字的蒐集狀態 : false

            Collected_Clue[0].SetActive(false); // 隱藏線索庫中的關鍵字

            Orginal_Clue[0].SetActive(true); // 顯示書籍區中的關鍵字(原本蒐集後已經變為隱藏狀態)

            gameManager.ClueNum_Book1--; // 關鍵字蒐集數量 - 1

            Clue_Trans[gameManager.ClueNum_Book1].position = Collected_Clue[0].transform.position;
    ...
    {
        Debug.Log("Return Book1_Keyword2");

        if (gameManager.ClueNum_Book1 > 0)
        {
            gameManager.Book1_Keyword2 = false;

            Collected_Clue[1].SetActive(false);

            Orginal_Clue[1].SetActive(true);

            gameManager.ClueNum_Book1--;
            
            Clue_Trans[gameManager.ClueNum_Book1].position = Collected_Clue[1].transform.position;
    ...
    {
        Debug.Log("Return Book1_Keyword3");

        if (gameManager.ClueNum_Book1 > 0)
        {
            gameManager.Book1_Keyword3 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book1].position = Collected_Clue[2].transform.position;
    ...
    {
        Debug.Log("Return Book1_Keyword4");

        if (gameManager.ClueNum_Book1 > 0)
        {
            gameManager.Book1_Keyword4 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book1].position = Collected_Clue[3].transform.position;
    ...
    {
        Debug.Log("Return Book1_Keyword5");

        if (gameManager.ClueNum_Book1 > 0)
        {
            gameManager.Book1_Keyword5 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book1].position = Collected_Clue[4].transform.position;
    ...
    {
        Debug.Log("Return Book1_Keyword6");

        if (gameManager.ClueNum_Book1 > 0)
        {
            gameManager.Book1_Keyword6 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book1].position = Collected_Clue[5].transform.position;
    ...
    {
        Debug.Log("Return Book1_Keyword7");

        if (gameManager.ClueNum_Book1 > 0)
        {
            gameManager.Book1_Keyword7 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book1].position = Collected_Clue[6].transform.position;
    ...
    {
        Debug.Log("Return Book1_Keyword8");

        if (gameManager.ClueNum_Book1 > 0)
        {
            gameManager.Book1_Keyword8 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book1].position = Collected_Clue[7].transform.position;
    ...
    {
        Debug.Log("Return Book1_Keyword9");

        if (gameManager.ClueNum_Book1 > 0)
        {
            gameManager.Book1_Keyword9 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book1].position = Collected_Clue[8].transform.position;
    ...
    {
        Debug.Log("Return Book1_Keyword10");

        if (gameManager.ClueNum_Book1 > 0)
        {
            gameManager.Book1_Keyword10 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book1].position = Collected_Clue[9].transform.position;
    ...
    {
        Debug.Log("Book1_Question1 is correct");
        ...
        gameManager.Book1_Question1 = true; // 書籍1的第一個問題已回答正確
    ...
    {
        Debug.Log("Book1_Question1 is wrong");

        Collected_Clue[0].transform.position = Return_Trans[0].position; // (線索庫)關鍵字回復到已記錄的回歸位置

        /*
        Quaternion rotation = Quaternion.Euler(Return_Rotat);
        Collected_Clue[0].transform.rotation = rotation;
        */
    ...
    public void ClueDetermine_2() // follow with Clue_list
    {
        ...
        { // pair the answer
            ...
            {
                Debug.Log("Not the request keyword(Book1_Keyword2)");
    ...
    // 憶臺雜記 第三個關鍵字；第二個正確的關鍵字/第五格答案
    public void ClueDetermine_3() // follow with Clue_list
    {
        if (CheckPoint.activeSelf == true)
        { // pair the answer
            if (Vector3.Distance(Collected_Clue[2].transform.position, Detect_Area[1].transform.position) < snapDistance)
            {
                SnapToCorrectPos_3();
                audioSource.volume = successVolume;
                audioSource.PlayOneShot(sound_Success);
            }
            else if (Vector3.Distance(Collected_Clue[2].transform.position, Detect_Area[1].transform.position) >= snapDistance)
            {
                ResetThePos_3();
                audioSource.volume = failVolume;
                audioSource.PlayOneShot(sound_Fail);
    ...
    {
        Debug.Log("Book1_Question5 is correct");
    ...
    {
        Debug.Log("Book1_Question5 is wrong");
    ...
    // 憶臺雜記 第四個關鍵字；第三個正確的關鍵字/第二格答案
    public void ClueDetermine_4() // follow with Clue_list
    {
        if (CheckPoint.activeSelf == true)
        { // pair the answer
            if (Vector3.Distance(Collected_Clue[3].transform.position, Detect_Area[2].transform.position) < snapDistance)
            {
                SnapToCorrectPos_4(); // Clue_1 is paired correctly
                audioSource.volume = successVolume;
                audioSource.PlayOneShot(sound_Success);
            }
            else if (Vector3.Distance(Collected_Clue[3].transform.position, Detect_Area[2].transform.position) >= snapDistance)
            {
                ResetThePos_4();
                audioSource.volume = failVolume;
                audioSource.PlayOneShot(sound_Fail);
    ...
    {
        Debug.Log("Book1_Question2 is correct");
    ...
    {
        Debug.Log("Book1_Question2 is wrong");
    ...
    {
        Debug.Log("Book1_Question6 is correct");
    ...
    {
        Debug.Log("Book1_Question6 is wrong");
    ...
    {
        Debug.Log("Book1_Question3 is correct");
    ...
    {
        Debug.Log("Book1_Question3 is wrong");
    ...
    public void ClueDetermine_7() // follow with Clue_list
    {
        ...
        { // pair the answer
            ...
            {
                Debug.Log("Not the request keyword(Book1_Keyword7)");
    ...
    {
        Debug.Log("Book1_Question4 is correct");
    ...
    {
        Debug.Log("Book1_Question4 is wrong");
    ...
    public void ClueDetermine_9() // follow with Clue_list
    {
        ...
        { // pair the answer
            ...
            {
                Debug.Log("Not the request keyword(Book1_Keyword9)");
    ...
    public void ClueDetermine_10() // follow with Clue_list
    {
        ...
        { // pair the answer
            ...
            {
                Debug.Log("Not the request keyword(Book1_Keyword10)");
