...
public class ReturnAndPairClue_Book1_3 : MonoBehaviour // 用來將置於線索庫的「關鍵字」配對到對應的測驗題目；將關鍵字放回初始位置(歸位至書籍區) (附加在 Clue_bank - Clue_Bank_Content - keyword_area1_1_Collection)
{
    ...
    public static int limitNum = 6; // 指定數量為6個(6個填答區域)
    ...
    void Update()
    {
        ...
        if (gameManager.ClueNum_Book3 > 0 && !gameManager.FinishExam_Book3) // 有關鍵字在線索庫中才會有「重選線索」功能
        {
        ...
        if (gameManager.ClueNum_Book3 >= limitNum) // 如果關鍵字蒐集數量達到指定要求(目前設定需要蒐集"限制數量"關鍵字)
        {
            ...
            gameManager.ClueComplete_Book3 = true; // 記錄該書的線索已經蒐集完畢
        } 
        else
        {
            BookTitle.text = BookName + "(" + gameManager.ClueNum_Book3 + "/" + limitNum + ")"; // 顯示關鍵字蒐集進度

            BookTitle.color = Color.black;

            BookImage.sprite = UnknownSprite;

            gameManager.ClueComplete_Book3 = false;

            CheckPoint.SetActive(false); // 未達成蒐集數量，書籍測驗畫面不會開啟
        }

        if (gameManager.ClueComplete_Book3)
        {
        ...
        if (gameManager.Book3_Question1 && gameManager.Book3_Question2 && gameManager.Book3_Question3 && gameManager.Book3_Question4 && gameManager.Book3_Question5 && gameManager.Book3_Question6) // 如果在CheckPoint視窗中，書籍測驗中的問題全部回答正確後
        {
            gameManager.FinishExam_Book3 = true;
    ...
    {
        Debug.Log("Reselect the Clue from Book3");
    ...
    {
        Debug.Log("Return Book3_Keyword1");

        if (gameManager.ClueNum_Book3 > 0) // 如果未達指定關鍵字蒐集數量
        {
            gameManager.Book3_Keyword1 = false; // 該關鍵字的蒐集狀態 : false

            Collected_Clue[0].SetActive(false); // 隱藏線索庫中的關鍵字

            Orginal_Clue[0].SetActive(true); // 顯示書籍區中的關鍵字(原本蒐集後已經變為隱藏狀態)

            gameManager.ClueNum_Book3--; // 關鍵字蒐集數量 - 1

            Clue_Trans[gameManager.ClueNum_Book3].position = Collected_Clue[0].transform.position;
    ...
    {
        Debug.Log("Return Book3_Keyword2");

        if (gameManager.ClueNum_Book3 > 0)
        {
            gameManager.Book3_Keyword2 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book3].position = Collected_Clue[1].transform.position;
    ...
    {
        Debug.Log("Return Book3_Keyword3");

        if (gameManager.ClueNum_Book3 > 0)
        {
            gameManager.Book3_Keyword3 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book3].position = Collected_Clue[2].transform.position;
    ...
    {
        Debug.Log("Return Book3_Keyword4");

        if (gameManager.ClueNum_Book3 > 0)
        {
            gameManager.Book3_Keyword4 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book3].position = Collected_Clue[3].transform.position;
    ...
    {
        Debug.Log("Return Book3_Keyword5");

        if (gameManager.ClueNum_Book3 > 0)
        {
            gameManager.Book3_Keyword5 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book3].position = Collected_Clue[4].transform.position;
    ...
    {
        Debug.Log("Return Book3_Keyword6");

        if (gameManager.ClueNum_Book3 > 0)
        {
            gameManager.Book3_Keyword6 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book3].position = Collected_Clue[5].transform.position;
    ...
    {
        Debug.Log("Return Book3_Keyword7");

        if (gameManager.ClueNum_Book3 > 0)
        {
            gameManager.Book3_Keyword7 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book3].position = Collected_Clue[6].transform.position;
    ...
    {
        Debug.Log("Return Book3_Keyword8");

        if (gameManager.ClueNum_Book3 > 0)
        {
            gameManager.Book3_Keyword8 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book3].position = Collected_Clue[7].transform.position;
    ...
    {
        Debug.Log("Return Book3_Keyword9");

        if (gameManager.ClueNum_Book3 > 0)
        {
            gameManager.Book3_Keyword9 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book3].position = Collected_Clue[8].transform.position;
    ...
    {
        Debug.Log("Return Book3_Keyword10");

        if (gameManager.ClueNum_Book3 > 0)
        {
            gameManager.Book3_Keyword10 = false;
            ...
            Clue_Trans[gameManager.ClueNum_Book3].position = Collected_Clue[9].transform.position;
    ...
    {
        Debug.Log("Book3_Question3 is correct");
        ...
        gameManager.Book3_Question3 = true; // 書籍1的第一個問題已回答正確
    ...
    {
        Debug.Log("Book3_Question3 is wrong");
    ...
    {
        Debug.Log("Book3_Question1 is correct");
        ...
        gameManager.Book3_Question1 = true; // 書籍1的第四個問題已回答正確
    ...
    {
        Debug.Log("Book3_Question1 is wrong");
    ...
    {
        Debug.Log("Book3_Question2 is correct");
    ...
    {
        Debug.Log("Book3_Question2 is wrong");
    ...
    public void ClueDetermine_4() // follow with Clue_list
    {
        ...
        { // pair the answer
            ...
            {
                Debug.Log("Not the request keyword(Book3_Keyword4)");
    ...
    public void ClueDetermine_5() // follow with Clue_list
    {
        ...
        { // pair the answer
            ...
            {
                Debug.Log("Not the request keyword(Book3_Keyword5)");
    ...
    // 恆春縣志 第六個關鍵字；第四個正確的關鍵字/第五格答案
    public void ClueDetermine_6() // follow with Clue_list
    {
        if (CheckPoint.activeSelf == true)
        { // pair the answer
            if (Vector3.Distance(Collected_Clue[5].transform.position, Detect_Area[3].transform.position) < snapDistance)
            {
                SnapToCorrectPos_6(); // Clue_1 is paired correctly
                audioSource.volume = successVolume;
                audioSource.PlayOneShot(sound_Success);
            }
            else if (Vector3.Distance(Collected_Clue[5].transform.position, Detect_Area[3].transform.position) >= snapDistance)
            {
                ResetThePos_6();
                audioSource.volume = failVolume;
                audioSource.PlayOneShot(sound_Fail);
    ...
    {
        Debug.Log("Book3_Question5 is correct");
    ...
    {
        Debug.Log("Book3_Question5 is wrong");
    ...
    public void ClueDetermine_7() // follow with Clue_list
    {
        ...
        { // pair the answer
            ...
            {
                Debug.Log("Not the request keyword(Book3_Keyword7)");
    ...
    // 恆春縣志 第八個關鍵字；第五個正確的關鍵字/第四格答案
    public void ClueDetermine_8() // follow with Clue_list
    {
        if (CheckPoint.activeSelf == true)
        { // pair the answer
            if (Vector3.Distance(Collected_Clue[7].transform.position, Detect_Area[4].transform.position) < snapDistance)
            {
                SnapToCorrectPos_8(); // Clue_1 is paired correctly
                audioSource.volume = successVolume;
                audioSource.PlayOneShot(sound_Success);
            }
            else if (Vector3.Distance(Collected_Clue[7].transform.position, Detect_Area[4].transform.position) >= snapDistance)
            {
                ResetThePos_8();
                audioSource.volume = failVolume;
                audioSource.PlayOneShot(sound_Fail);
    ...
    void SnapToCorrectPos_8() // 回答正確
    {
        Debug.Log("Book3_Question4 is correct");
    ...
    void ResetThePos_8() // 回答錯誤
    {
        Debug.Log("Book3_Question4 is wrong");
    ...
    public void ClueDetermine_9() // follow with Clue_list
    {
        ...
        { // pair the answer
            ...
            {
                Debug.Log("Not the request keyword(Book3_Keyword9)");
    ...
    // 恆春縣志 第十個關鍵字；第六個正確的關鍵字/第六格答案
    public void ClueDetermine_10() // follow with Clue_list
    {
        if (CheckPoint.activeSelf == true)
        { // pair the answer
            if (Vector3.Distance(Collected_Clue[9].transform.position, Detect_Area[5].transform.position) < snapDistance)
            {
                SnapToCorrectPos_10(); // Clue_1 is paired correctly
                audioSource.volume = successVolume;
                audioSource.PlayOneShot(sound_Success);
            }
            else if (Vector3.Distance(Collected_Clue[9].transform.position, Detect_Area[5].transform.position) >= snapDistance)
            {
                ResetThePos_10();
                audioSource.volume = failVolume;
                audioSource.PlayOneShot(sound_Fail);
    ...
    void SnapToCorrectPos_10() // 回答正確
    {
        Debug.Log("Book3_Question6 is correct");
    ...
    void ResetThePos_10() // 回答錯誤
    {
        Debug.Log("Book3_Question6 is wrong");
