...
public class PairPuzzle_1 : MonoBehaviour
{
    ...
    void Update()
    {
        if (gameManager.RegionReward_1 && !gameManager.finish_flag_1)
        {
    ...
    void SnapToCorrectPos_1()
    {
        ...
        Complete_Puzzle[0].GetComponent<Image>().color = new Color32(255, 255, 255, 255);
        ...
        if (step == Detect_Area.Count)
        {
            ...
            gameManager.RegionReward_1 = true;
        }
    }
    ...
    void SnapToCorrectPos_2()
    {
        ...
        Complete_Puzzle[1].GetComponent<Image>().color = new Color32(255, 255, 255, 255);
    ...
    void SnapToCorrectPos_3()
    {
        ...
        Complete_Puzzle[2].GetComponent<Image>().color = new Color32(255, 255, 255, 255);
    ...
    void SnapToCorrectPos_4()
    {
        ...
        Complete_Puzzle[3].GetComponent<Image>().color = new Color32(255, 255, 255, 255);
    ...
    void SnapToCorrectPos_5()
    {
        ...
        Complete_Puzzle[4].GetComponent<Image>().color = new Color32(255, 255, 255, 255);
    ...
    {
        gameManager.finish_flag_1 = true;
    }

    public void FinishRegion()
    {
        gameManager.Complete_Region_1 = true;
    }
}